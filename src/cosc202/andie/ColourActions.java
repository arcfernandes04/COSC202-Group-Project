...
public class ColourActions {
    ...
    public ColourActions() {
        ...
        actions.add(new ConvertToGreyAction(Language.getWord("Greyscale"), null, "Convert to greyscale", Integer.valueOf(KeyEvent.VK_G)));
        actions.add(new BrightnessContrastAction(Language.getWord("BrightnessContrast"), null, "Adjust brightness and contrast levels", Integer.valueOf(KeyEvent.VK_B)));
    }
