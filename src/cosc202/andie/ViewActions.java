...
public class ViewActions {
    ...
    public ViewActions() {
        ...
        actions.add(new ZoomInAction(Language.getWord("ZoomIn"), null, "Zoom In", Integer.valueOf(KeyEvent.VK_PLUS)));
        actions.add(new ZoomOutAction(Language.getWord("ZoomOut"), null, "Zoom Out", Integer.valueOf(KeyEvent.VK_MINUS)));
        actions.add(new ZoomFullAction(Language.getWord("ZoomFull"), null, "Zoom Full", Integer.valueOf(KeyEvent.VK_1)));
    }
